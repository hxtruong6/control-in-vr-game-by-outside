...
public class NetworkServerUI : MonoBehaviour
{
    ...
    public PlayerMoving objectMovingInServer;
...
//        GUI.Label(new Rect(20, Screen.height - 20, 100, 20), "Connected: " + NetworkServer.connections.Count);
        if (NetworkServer.connections.Count == 0)
        {
            ...
            InfoText.text = "Host IP: " + ipAddress +
    ...
    private void ServerReceiveMessage(NetworkMessage netmsg)
    {
        ...
        var jump = Convert.ToBoolean(deltas[2]);
//        var jump = false;
        objectMovingInServer.MovingUpdate(vertical, horizontal, jump);
    }
